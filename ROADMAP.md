...
- [ ] **W1c-11+** — smooth zoom transitions (overlay animations + compositor mode-change blends); live thumbnails (smithay scene graph + buffer-capture); DRM backend (~2000-line port from anvil — multi-session); libinput gesture integration.
