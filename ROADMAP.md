...
- [ ] **W1c-4+** — xdg-shell move/resize grabs wired via the daemon drag flow; smooth zoom transitions; live thumbnails (smithay scene graph); DRM backend (replace winit); libinput gesture integration; xdg-decoration + xwayland.
