...
- [ ] **W1c-17+** — Verify clients render under `WM_BACKEND=wlroots VIBEWM_BACKEND=udev` (foot, panel, launcher); draw a visible cursor; smooth zoom transitions; live thumbnails; libinput gesture integration.
