...
- [ ] **W1c-10+** — smooth zoom transitions; live thumbnails (smithay scene graph + buffer-capture); DRM backend (~2000-line port from anvil); libinput gesture integration; X11 move/resize grab adapter.
