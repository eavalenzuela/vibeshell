...
- [ ] **W1c-9+** — smooth zoom transitions; live thumbnails (smithay scene graph); DRM backend (replace winit, ~2000-line port from anvil); libinput gesture integration; xwayland.
