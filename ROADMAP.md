...
- [ ] Daemon ↔ vibewm bridge (W1c): `WlrootsBackend impl WmBackend` so `WM_BACKEND=wlroots` unlocks the same control plane Sway has today (snapshot, layout apply, focus, event stream)
